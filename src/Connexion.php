...
class Connexion {
     ...
     * Permet de regrouper plusieurs requêtes (INSERT, UPDATE, DELETE)
     * afin de garantir le principe ACID « tout ou rien » :
     * si une erreur survient, aucune modification n’est appliquée.
     *
     * @return bool true si la transaction démarre correctement, false sinon
     */
    ...
    /**
     * Valide définitivement la transaction en cours.
     * Toutes les opérations SQL exécutées depuis le beginTransaction()
     * sont alors enregistrées de manière permanente dans la base de données.
     *
     * @return bool true si la validation est effectuée, false sinon
     */
     ...
     * En cas d’erreur lors d’une opération SQL, cette méthode permet
     * de revenir à l’état initial de la base de données avant la transaction,
     * garantissant ainsi l’intégrité et la cohérence des données.
     *
     * @return bool true si l’annulation est effectuée, false sinon
     */
